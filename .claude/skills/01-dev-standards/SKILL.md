...
CLAUDE.md AI Implementation Rules 1~9의 구체적 적용 방법을 기술한다.
...
- 시크릿(API Key, OAuth Client Secret) `.env` 포함 금지 (Rule 8)
...
작업 시작 전 반드시 수행:
- [ ] `CLAUDE.md` 규칙 확인 (특히 Rules 10~14)
- [ ] 관련 `docs/*.md` 비즈니스 명세 읽기 (Rule 13)
